...
SWIFT_MODULE_NAMESPACE_PUSH("CloudCherryiOSFramework")
...
///
/// \param iToken Token for authentication
///
- (void)initialise:(NSString * _Nonnull)iUsername iPassword:(NSString * _Nonnull)iPassword iToken:(NSString * _Nonnull)iToken;
/// Initalize the CloudCherry SDK with username, password and token config. This method has to be called mandatorily.
/// \param iUsername Username for user authentication
///
/// \param iPassword Password for user authentication
///
/// \param iTokenConfig Token Config for authentication
///
- (void)initialise:(NSString * _Nonnull)iUsername iPassword:(NSString * _Nonnull)iPassword iTokenConfig:(SurveyConfig * _Nonnull)iTokenConfig;
/// Initalize the Unique ID. This method has to be called mandatorily.
/// \param iDictionary Fields should either be “email” or “mobile”. String key value for both
///
- (void)setUniqueId:(NSDictionary * _Nonnull)iDictionary;
...
- (NSArray<NSDictionary *> * _Nullable)getAnalyticsDataAfterTestFinish SWIFT_WARN_UNUSED_RESULT;
...
///
/// \param iToThrottle To enable throttling in survey.
///
- (void)showSurveyInController:(UIViewController * _Nonnull)iController iToThrottle:(BOOL)iToThrottle;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC23CloudCherryiOSFramework12SurveyConfig")
@interface SurveyConfig : NSObject
@property (nonatomic) NSInteger numberOfUses;
...
SWIFT_CLASS("_TtC23CloudCherryiOSFramework15ThrottlingLogic")
@interface ThrottlingLogic : NSObject
- (NSDictionary * _Nonnull)generateLogicFromResponse:(NSArray * _Nonnull)iResponse SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
